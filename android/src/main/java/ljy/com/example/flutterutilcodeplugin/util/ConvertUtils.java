...
import ljy.com.example.flutterutilcodeplugin.constant.MemoryConstants;
...
public final class ConvertUtils {
    ...
    public static Drawable bytes2Drawable(final Context mContext,final byte[] bytes) {
        return UtilsBridge.bytes2Drawable(mContext,bytes);
    }
    ...
    public static Drawable bitmap2Drawable(final Context mContext,final Bitmap bitmap) {
        return UtilsBridge.bitmap2Drawable(mContext,bitmap);
    }
